<x-layouts.app>
    <div class="p-6 md:p-8 max-w-3xl">
        ...
        <div class="flex items-center gap-3 mb-8">
            ...
            <div>
                ...
                <p class="text-sm text-slate-500 mt-0.5">Preencha os dados do cliente e seus acessos.</p>
            </div>
        </div>

        <form method="POST" action="{{ route('clientes.store') }}" id="form-cliente">
            @csrf
            ...
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 mb-6">
                ...
                <p id="credenciais-empty" class="text-sm text-slate-400 text-center py-6 italic">
                    Nenhum acesso adicionado. Clique em "Adicionar acesso" para incluir logins e senhas dos sistemas do cliente.
                </p>
            </div>
    ...
    <script>
        let credencialIndex = 0;

        function adicionarCredencial(dados = {}) {
            ...
            div.innerHTML = `
                <div class="flex items-center justify-between mb-3">
                    <span class="text-xs font-semibold text-slate-500 uppercase tracking-wide">Acesso ${lista.children.length + 1}</span>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div>
                        ...
                        <input type="text" name="credenciais[${idx}][sistema]" value="${dados.sistema || ''}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="credenciais[${idx}][login]" value="${dados.login || ''}"
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <input type="text" name="credenciais[${idx}][observacao]" value="${dados.observacao || ''}"
